...
public class SearchAdapter extends BaseAdapter{
	...
	public SearchAdapter(Context context, List<MainListBean> beans) {
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		holder.iv_image.setImageURI(beans.get(p).getHoverURL());}
//		imageLoader.displayImage(beans.get(p).get_thumb(), holder.iv_image, options, null);
		return view;
	}
